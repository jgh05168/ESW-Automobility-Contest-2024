...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
/// GENERATED FILE NAME               : svinferencedata_proxy.h
...
///                                                                                                        
///////////////////////////////////////////////////////////////////////////////////////////////////////////
#ifndef PARA_COM_GEN_SERVICE_INTERFACE_SVINFERENCEDATA_PROXY_H
#define PARA_COM_GEN_SERVICE_INTERFACE_SVINFERENCEDATA_PROXY_H
///////////////////////////////////////////////////////////////////////////////////////////////////////////
/// INCLUSION HEADER FILES
///////////////////////////////////////////////////////////////////////////////////////////////////////////
/// @uptrace{SWS_CM_01004}
#include "svinferencedata_common.h"
...
public:
    ...
    using SampleType = deepracer::type::InferenceDataNode;
    /// @brief Constructor
    explicit IEvent(para::com::ProxyInterface* interface) : mInterface(interface)
    {
    }
    /// @brief Destructor
    ...
    IEvent(IEvent&& other) noexcept : mInterface(other.mInterface)
    {
...
private:
    ...
    const std::string kCallSign = {"IEvent"};
};
} /// namespace events
...
public: 
    ...
    static ara::core::Result<ara::com::FindServiceHandle> StartFindService(ara::com::FindServiceHandler<SvInferenceDataProxy::HandleType> handler, ara::core::InstanceSpecifier instanceSpec)
    {
        ...
        auto findCallback = [&, handler, findHandle, instanceSpec](std::vector<para::com::ServiceHandle> services) {
            ara::com::ServiceHandleContainer<SvInferenceDataProxy::HandleType> handleContainer;
    ...
    static ara::core::Result<ara::com::ServiceHandleContainer<SvInferenceDataProxy::HandleType>> FindService(ara::core::InstanceSpecifier instanceSpec)
    {
        auto result = para::com::ProxyInterface::FindService(instanceSpec);
        if (!result.HasValue())
        {
            return ara::core::Result<ara::com::ServiceHandleContainer<SvInferenceDataProxy::HandleType>>::FromError(result.Error());
        }
        ara::com::ServiceHandleContainer<SvInferenceDataProxy::HandleType> handleContainer;
    ...
    explicit SvInferenceDataProxy(HandleType& handle)
        : mHandle(handle)
        , mInterface(std::make_unique<para::com::ProxyInterface>(handle.GetInstanceSpecifier(), handle.GetServiceHandle()))
        , IEvent(mInterface.get())
    {
    }
    /// @brief Destructor
    /// @uptrace{SWS_CM_10446}
    ~SvInferenceDataProxy() = default;
    /// @brief Delete copy constructor
    /// @uptrace{SWS_CM_00136}
    SvInferenceDataProxy(SvInferenceDataProxy& other) = delete;
    /// @brief Delete copy assignment
    /// @uptrace{SWS_CM_00136}
    SvInferenceDataProxy& operator=(const SvInferenceDataProxy& other) = delete;
    /// @brief Move constructor
    /// @uptrace{SWS_CM_00137}
    SvInferenceDataProxy(SvInferenceDataProxy&& other) noexcept
        : mHandle(std::move(other.mHandle))
        , mInterface(std::move(other.mInterface))
        , IEvent(std::move(other.IEvent))
    {
    ...
    /// @brief Move assignment
    /// @uptrace{SWS_CM_00137}
    SvInferenceDataProxy& operator=(SvInferenceDataProxy&& other) noexcept
    {
        mHandle = std::move(other.mHandle);
        mInterface = std::move(other.mInterface);
        mInterface->StopFindService();
...
#endif /// PARA_COM_GEN_SERVICE_INTERFACE_SVINFERENCEDATA_PROXY_H