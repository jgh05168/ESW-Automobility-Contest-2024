...
navigate::aa::Navigate* g_swcNavigate{nullptr};
 
static void SignalHandler(std::int32_t signal)
{
    if (signal == SIGTERM || signal == SIGINT)
    {
        g_swcNavigate->Terminate();
    }
}
...
int main(int argc, char *argv[], char* envp[])
{
    ...
    if (araInitialized)
    {
        ara::log::Logger& appLogger{ara::log::CreateLogger("NAV", "Navigate's main function")};
        ...
        navigate::aa::Navigate swcNavigate;
        g_swcNavigate = &swcNavigate;
        
        // initialize software component
        proceed = swcNavigate.Initialize();
