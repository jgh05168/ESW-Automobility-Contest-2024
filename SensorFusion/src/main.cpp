...
sensorfusion::aa::SensorFusion* g_swcSensorFusion{nullptr};
 
static void SignalHandler(std::int32_t signal)
{
    if (signal == SIGTERM || signal == SIGINT)
    {
        g_swcSensorFusion->Terminate();
    }
}
...
int main(int argc, char *argv[], char* envp[])
{
    ...
    if (araInitialized)
    {
        ara::log::Logger& appLogger{ara::log::CreateLogger("SSFU", "SensorFusion's main function")};
        ...
        sensorfusion::aa::SensorFusion swcSensorFusion;
        g_swcSensorFusion = &swcSensorFusion;
        
        // initialize software component
        proceed = swcSensorFusion.Initialize();
